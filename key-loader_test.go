  ...
  "url": {
    ...
    "mediaType": "text/html"
			...
			want: vocab.Actor{
				...
				Name:              vocab.DefaultLangValue("#activitypub"),
				PreferredUsername: vocab.DefaultLangValue("activitypub"),
				Icon:              &vocab.Link{Type: vocab.LinkType, Href: "http://example.com/user/activitypub/icon"},
				Summary:           vocab.DefaultLangValue("<p>Follow me if you&apos;re interested in the #activitypub hashtag.</p>"),
